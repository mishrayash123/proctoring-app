...
export const NO_CHEATING_RESULT= {
  image: null,
  detections: [
    {
      boundingBox: null,
...
export const NO_CHEATING_COORD= {
...
export const LOOKING_LEFT_RESULT = {
  image: null,
  detections: [
    {
      boundingBox: null,
...
export const LOOKING_LEFT_COORD= {
...
export const LOOKING_RIGHT_RESULT = {
  image: null,
  detections: [
    {
      boundingBox: null,
...
export const LOOKING_RIGHT_COORD= {
  leftEye: 0.37106189131736755,
  leftEar: 0.37398236989974976,
  rightEye: 0.5058948397636414,
  rightEar: 0.6752753257751465,
